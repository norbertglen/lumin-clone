...
import { SimpleGrid, Skeleton, Alert, AlertIcon, Stack, Flex } from "@chakra-ui/react"
...
const ProductList: React.FC = () => {
  ...
  return (
    <Flex bg="brand.100" pb={20}>
      {data && <SimpleGrid w="container.xl" columns={[2, null, 3]} m="auto" mt={6} pt={15} spacing={15}>
